...
'After you compile vWATCH64, drag this .bas file into vwatch64.exe
'to monitor the values of the variables below in real time.
'
_DEFINE A-Z AS _UNSIGNED _INTEGER64
DIM SHARED a AS STRING, fe(1 TO 5) AS LONG, i AS _UNSIGNED LONG
DIM yname AS STRING
